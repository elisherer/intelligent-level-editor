...
namespace IntelligentLevelEditor.Games.DenpaMen
{
    public static class Crypt
    {
        ...
        private static readonly byte[][] Alphanumerics = new[] {
	        new byte[] { 0x2A , 0x24 }, new byte[] { 0x25 , 0x58 }, new byte[] { 0x2B , 0x49 },
	        new byte[] { 0x25 , 0x5A }, new byte[] { 0x2A , 0x38 }, new byte[] { 0x2A , 0x39 },
	        new byte[] { 0x25 , 0x59 }, new byte[] { 0x2B , 0x4E }, new byte[] { 0x2E , 0x44 },
	        new byte[] { 0x2A , 0x2D }, new byte[] { 0x2A , 0x2E }, new byte[] { 0x2A , 0x2F },
	        new byte[] { 0x2A , 0x20 }, new byte[] { 0x2D , 0x24 }, new byte[] { 0x2E , 0x4A },
	        new byte[] { 0x2E , 0x4B }, new byte[] { 0x2A , 0x34 }, new byte[] { 0x2A , 0x35 },
	        new byte[] { 0x2A , 0x36 }, new byte[] { 0x2A , 0x37 }, new byte[] { 0x2B , 0x53 },
	        new byte[] { 0x2E , 0x51 }, new byte[] { 0x2E , 0x52 }, new byte[] { 0x2E , 0x53 },
	        new byte[] { 0x2B , 0x47 }, new byte[] { 0x2D , 0x30 }, new byte[] { 0x2B , 0x41 },
	        new byte[] { 0x2B , 0x42 }, new byte[] { 0x2A , 0x30 }, new byte[] { 0x2A , 0x31 },
	        new byte[] { 0x2A , 0x32 }, new byte[] { 0x2A , 0x33 }, new byte[] { 0x20 , 0x20 },
	        new byte[] { 0x24 , 0x31 }, new byte[] { 0x24 , 0x32 }, new byte[] { 0x24 , 0x33 },
	        new byte[] { 0x20 , 0x24 }, new byte[] { 0x20 , 0x25 }, new byte[] { 0x24 , 0x36 },
	        new byte[] { 0x24 , 0x37 }, new byte[] { 0x24 , 0x38 }, new byte[] { 0x24 , 0x39 },
	        new byte[] { 0x20 , 0x2A }, new byte[] { 0x20 , 0x2B }, new byte[] { 0x25 , 0x47 },
	        new byte[] { 0x20 , 0x2D }, new byte[] { 0x20 , 0x2E }, new byte[] { 0x20 , 0x2F },
	        new byte[] { 0x20 , 0x30 }, new byte[] { 0x20 , 0x31 }, new byte[] { 0x20 , 0x32 },
	        new byte[] { 0x20 , 0x33 }, new byte[] { 0x20 , 0x34 }, new byte[] { 0x20 , 0x35 },
	        new byte[] { 0x20 , 0x36 }, new byte[] { 0x20 , 0x37 }, new byte[] { 0x20 , 0x38 },
	        new byte[] { 0x20 , 0x39 }, new byte[] { 0x20 , 0x3A }, new byte[] { 0x25 , 0x52 },
	        new byte[] { 0x25 , 0x57 }, new byte[] { 0x25 , 0x54 }, new byte[] { 0x25 , 0x51 },
	        new byte[] { 0x25 , 0x56 }, new byte[] { 0x24 , 0x50 }, new byte[] { 0x20 , 0x41 },
	        new byte[] { 0x20 , 0x42 }, new byte[] { 0x20 , 0x43 }, new byte[] { 0x20 , 0x44 },
	        new byte[] { 0x20 , 0x45 }, new byte[] { 0x20 , 0x46 }, new byte[] { 0x20 , 0x47 },
	        new byte[] { 0x20 , 0x48 }, new byte[] { 0x20 , 0x49 }, new byte[] { 0x20 , 0x4A },
	        new byte[] { 0x20 , 0x4B }, new byte[] { 0x20 , 0x4C }, new byte[] { 0x20 , 0x4D },
	        new byte[] { 0x20 , 0x4E }, new byte[] { 0x20 , 0x4F }, new byte[] { 0x20 , 0x50 },
	        new byte[] { 0x20 , 0x51 }, new byte[] { 0x20 , 0x52 }, new byte[] { 0x20 , 0x53 },
	        new byte[] { 0x20 , 0x54 }, new byte[] { 0x20 , 0x55 }, new byte[] { 0x20 , 0x56 },
	        new byte[] { 0x20 , 0x57 }, new byte[] { 0x20 , 0x58 }, new byte[] { 0x20 , 0x59 },
	        new byte[] { 0x20 , 0x5A }, new byte[] { 0x2F , 0x3A }, new byte[] { 0x35 , 0x57 },
	        new byte[] { 0x35 , 0x54 }, new byte[] { 0x35 , 0x51 }, new byte[] { 0x35 , 0x56 },
	        new byte[] { 0x3A , 0x44 }, new byte[] { 0x3A , 0x45 }, new byte[] { 0x3A , 0x46 },
	        new byte[] { 0x3A , 0x47 }, new byte[] { 0x39 , 0x37 }, new byte[] { 0x33 , 0x4C },
	        new byte[] { 0x32 , 0x2A }, new byte[] { 0x32 , 0x2B }, new byte[] { 0x2B , 0x57 },
	        new byte[] { 0x2B , 0x50 }, new byte[] { 0x2B , 0x51 }, new byte[] { 0x2B , 0x52 },
	        new byte[] { 0x56 , 0x48 }, new byte[] { 0x2B , 0x54 }, new byte[] { 0x2B , 0x55 },
	        new byte[] { 0x2B , 0x56 }, new byte[] { 0x2F , 0x2F }, new byte[] { 0x24 , 0x41 },
	        new byte[] { 0x24 , 0x42 }, new byte[] { 0x24 , 0x43 }, new byte[] { 0x24 , 0x44 },
	        new byte[] { 0x24 , 0x45 }, new byte[] { 0x24 , 0x46 }, new byte[] { 0x24 , 0x47 },
	        new byte[] { 0x24 , 0x48 }, new byte[] { 0x24 , 0x49 }, new byte[] { 0x24 , 0x4A },
	        new byte[] { 0x24 , 0x4B }, new byte[] { 0x24 , 0x4C }, new byte[] { 0x24 , 0x4D },
	        new byte[] { 0x24 , 0x4E }, new byte[] { 0x24 , 0x4F }, new byte[] { 0x32 , 0x44 },
	        new byte[] { 0x31 , 0x20 }, new byte[] { 0x25 , 0x25 }, new byte[] { 0x32 , 0x47 },
	        new byte[] { 0x32 , 0x48 }, new byte[] { 0x31 , 0x24 }, new byte[] { 0x32 , 0x4A },
	        new byte[] { 0x32 , 0x4B }, new byte[] { 0x31 , 0x2B }, new byte[] { 0x25 , 0x20 },
	        new byte[] { 0x25 , 0x2D }, new byte[] { 0x31 , 0x2A }, new byte[] { 0x31 , 0x2F },
	        new byte[] { 0x25 , 0x24 }, new byte[] { 0x36 , 0x2A }, new byte[] { 0x31 , 0x2E },
	        new byte[] { 0x25 , 0x2B }, new byte[] { 0x2E , 0x2D }, new byte[] { 0x25 , 0x35 },
	        new byte[] { 0x25 , 0x2A }, new byte[] { 0x25 , 0x2F }, new byte[] { 0x31 , 0x34 },
	        new byte[] { 0x31 , 0x39 }, new byte[] { 0x25 , 0x2E }, new byte[] { 0x25 , 0x33 },
	        new byte[] { 0x25 , 0x30 }, new byte[] { 0x37 , 0x49 }, new byte[] { 0x25 , 0x32 },
	        new byte[] { 0x25 , 0x37 }, new byte[] { 0x25 , 0x34 }, new byte[] { 0x25 , 0x31 },
	        new byte[] { 0x25 , 0x36 }, new byte[] { 0x2A , 0x44 }, new byte[] { 0x2A , 0x45 },
	        new byte[] { 0x2A , 0x46 }, new byte[] { 0x2A , 0x47 }, new byte[] { 0x2A , 0x58 },
	        new byte[] { 0x2A , 0x59 }, new byte[] { 0x2A , 0x5A }, new byte[] { 0x37 , 0x56 },
	        new byte[] { 0x2A , 0x4C }, new byte[] { 0x2A , 0x4D }, new byte[] { 0x2A , 0x4E },
	        new byte[] { 0x2A , 0x4F }, new byte[] { 0x2D , 0x47 }, new byte[] { 0x2A , 0x41 },
	        new byte[] { 0x2A , 0x42 }, new byte[] { 0x2A , 0x43 }, new byte[] { 0x2A , 0x54 },
	        new byte[] { 0x2A , 0x55 }, new byte[] { 0x2A , 0x56 }, new byte[] { 0x2A , 0x57 },
	        new byte[] { 0x34 , 0x24 }, new byte[] { 0x34 , 0x25 }, new byte[] { 0x35 , 0x49 },
	        new byte[] { 0x35 , 0x4E }, new byte[] { 0x2D , 0x53 }, new byte[] { 0x2D , 0x50 },
	        new byte[] { 0x34 , 0x2A }, new byte[] { 0x2D , 0x52 }, new byte[] { 0x2A , 0x50 },
	        new byte[] { 0x2A , 0x51 }, new byte[] { 0x2A , 0x52 }, new byte[] { 0x2A , 0x53 },
	        new byte[] { 0x3A , 0x24 }, new byte[] { 0x3A , 0x25 }, new byte[] { 0x41 , 0x45 },
	        new byte[] { 0x33 , 0x2A }, new byte[] { 0x41 , 0x47 }, new byte[] { 0x41 , 0x44 },
	        new byte[] { 0x33 , 0x2D }, new byte[] { 0x33 , 0x2E }, new byte[] { 0x2B , 0x37 },
	        new byte[] { 0x2B , 0x30 }, new byte[] { 0x2B , 0x31 }, new byte[] { 0x2B , 0x32 },
	        new byte[] { 0x3A , 0x20 }, new byte[] { 0x2B , 0x34 }, new byte[] { 0x2B , 0x35 },
	        new byte[] { 0x2B , 0x36 }, new byte[] { 0x24 , 0x20 }, new byte[] { 0x3A , 0x35 },
	        new byte[] { 0x3A , 0x36 }, new byte[] { 0x3A , 0x37 }, new byte[] { 0x24 , 0x24 },
	        new byte[] { 0x24 , 0x25 }, new byte[] { 0x3A , 0x2A }, new byte[] { 0x3A , 0x2B },
	        new byte[] { 0x34 , 0x48 }, new byte[] { 0x33 , 0x20 }, new byte[] { 0x24 , 0x2A },
	        new byte[] { 0x24 , 0x2B }, new byte[] { 0x3A , 0x30 }, new byte[] { 0x24 , 0x2D },
	        new byte[] { 0x24 , 0x2E }, new byte[] { 0x24 , 0x2F }, new byte[] { 0x2B , 0x2F },
	        new byte[] { 0x25 , 0x38 }, new byte[] { 0x2F , 0x41 }, new byte[] { 0x25 , 0x3A },
	        new byte[] { 0x2E , 0x20 }, new byte[] { 0x2F , 0x44 }, new byte[] { 0x25 , 0x39 },
	        new byte[] { 0x2B , 0x2E }, new byte[] { 0x2E , 0x24 }, new byte[] { 0x2E , 0x25 },
	        new byte[] { 0x2F , 0x49 }, new byte[] { 0x2F , 0x4A }, new byte[] { 0x2B , 0x2B },
	        new byte[] { 0x2F , 0x4C }, new byte[] { 0x2E , 0x2A }, new byte[] { 0x2E , 0x2B },
	        new byte[] { 0x38 , 0x30 }, new byte[] { 0x2B , 0x38 }, new byte[] { 0x2B , 0x39 },
	        new byte[] { 0x2B , 0x3A }, new byte[] { 0x2B , 0x33 }, new byte[] { 0x2E , 0x31 },
	        new byte[] { 0x2E , 0x32 }, new byte[] { 0x2E , 0x33 }, new byte[] { 0x2E , 0x34 },
	        new byte[] { 0x2B , 0x20 }, new byte[] { 0x2E , 0x36 }, new byte[] { 0x2E , 0x37 },
	        new byte[] { 0x2E , 0x38 }, new byte[] { 0x2B , 0x24 }, new byte[] { 0x2B , 0x25 },
	        new byte[] { 0x39 , 0x4E }
        };
        #endregion
        
        private static byte GetLowNibble(byte b0, byte b1)
        {
            var lineIndex = b0 % 8;
            var parity = b1 % 2;
            var startVal = parity;
        ...
        private static byte GetHighNibble(byte b0, byte b1)
        {
