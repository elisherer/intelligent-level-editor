...
namespace IntelligentLevelEditor.Games.Pushmo
{
    ...
    class PushmoLevelData
    {
        private string _name = "";

        [CategoryAttribute("Pushmo"), DescriptionAttribute("Name of the level"), PropertyOrder(0)]
        public string Name
        {
            get { return _name;}
            set
        ...
        [CategoryAttribute("Pushmo"), DescriptionAttribute("The difficulty level (1-5)"), TypeConverter(typeof(EnumDescriptionConverter)), PropertyOrder(1)]
        public Difficulty Difficulty { set; get; }
        [CategoryAttribute("Pushmo"), DescriptionAttribute("Toggle editing inside the studio."), PropertyOrder(2)]
        public bool Locked { set; get; }
        [CategoryAttribute("Pushmo"), DescriptionAttribute("Toggle if the size is 32x32 or 16x16."), PropertyOrder(3)]
